...
const ROLES = {
  ...
  analyste: { name: "L'Analyste", camp: 'bien', superpower: "Chaque nuit, choisissez un collègue. On vous dit combien de ses voisins directs (à sa gauche et à sa droite dans l'ordre de table) sont dans le Leadership." },
  ...
  renderHome() {
    return `
      <div class="screen" style="justify-content:center;align-items:center;gap:30px;background:linear-gradient(135deg, var(--logo-red) 0%, var(--logo-blue) 100%);">
        ...
        <p style="font-size:0.8rem;opacity:0.4;">v1.0 — "Le Plan de Succession"</p>
      </div>
    `;
  }
